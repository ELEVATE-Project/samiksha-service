module.exports = {
  ...
  PROGRAM_UPDATE_FAILED: 'Program update failed',
  ...
  OBSERVATION_SOLUTION_NOT_ALLOWED_TO_BE_CONSUMED:
    'The observation link is not relevant to your selected profile details',
  ...
  OBS_EXPIRED: "Observation has passed its end date, this action can't be taken."
};
