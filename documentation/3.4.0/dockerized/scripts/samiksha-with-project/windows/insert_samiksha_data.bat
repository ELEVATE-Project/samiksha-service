...
https://raw.githubusercontent.com/ELEVATE-Project/samiksha-service/refs/heads/main/documentation/3.4.0/common-files/dockerized/samiksha-with-project/entity_sampleData.js

curl -L -o project_sampleData.js ^
https://raw.githubusercontent.com/ELEVATE-Project/samiksha-service/refs/heads/main/documentation/3.4.0/common-files/dockerized/samiksha-with-project/project_sampleData.js

curl -L -o survey_sampleData.js ^
https://raw.githubusercontent.com/ELEVATE-Project/samiksha-service/refs/heads/main/documentation/3.4.0/common-files/dockerized/samiksha-with-project/survey_sampleData.js

curl -L -o insert_sample_solutions.js ^
https://raw.githubusercontent.com/ELEVATE-Project/samiksha-service/refs/heads/main/documentation/3.4.0/common-files/dockerized/samiksha-with-project/insert_sample_solutions.js
