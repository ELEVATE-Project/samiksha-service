...
# Docker Setup Samiksha Service - With Project (Ubuntu)
...
1. **Download and execute main setup script:** Execute the following command in your terminal from the samiksha directory.
    ```
    curl -OJL https://raw.githubusercontent.com/ELEVATE-Project/samiksha-service/refs/heads/main/documentation/3.4.0/dockerized/scripts/samiksha-with-project/ubuntu/setup_samiksha.sh && chmod +x setup_samiksha.sh && sudo ./setup_samiksha.sh
    ```
...
**Keep the current terminal session active, and kindly open a new terminal window within the samiksha directory.**
...
During the initial setup of Samiksha services with the default configuration, you may encounter issues creating new accounts through the regular SignUp flow on the project portal. This typically occurs because the default SignUp process includes OTP verification to prevent abuse. Until the notification service is configured correctly to send actual emails, you will not be able to create new accounts.
...
This step will guide us in implementing a sample project and Samiksha solution following the initial setup of the project service.
...
### 🛠️ Adding New Survey and Observation to the System
