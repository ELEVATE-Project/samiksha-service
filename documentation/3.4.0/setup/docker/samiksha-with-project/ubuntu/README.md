...
1. **Download and execute main setup script:** Execute the following command in your terminal from the samiksha directory.
    ```
    curl -OJL https://raw.githubusercontent.com/ELEVATE-Project/samiksha-service/refs/heads/dockerSamikshaSetupGuide/documentation/3.4.0/dockerized/scripts/samiksha-with-project/ubuntu/setup_samiksha.sh && chmod +x setup_samiksha.sh && sudo ./setup_samiksha.sh
    ```
